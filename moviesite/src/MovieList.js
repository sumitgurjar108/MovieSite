...
// Full-screen movie display component
const FullScreenMovie = ({ movie, onClose }) => {
	return (
		<div className="full-screen-movie">
			<div className="full-screen-content">
				<button className="close-button" onClick={onClose}>X</button>
				<img src={movie.image} alt={movie.title} className="full-screen-image" />
				<h2>{movie.title}</h2>
...
// Movie list component with click functionality for full-screen view
const MovieList = () => {
	...
	return (
		<div className="movie-list">
			...
			{selectedMovie && (
				<FullScreenMovie movie={selectedMovie} onClose={handleCloseFullScreen} />
			)}
		</div>
	);
};
